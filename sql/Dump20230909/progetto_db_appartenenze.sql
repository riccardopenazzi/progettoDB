...
CREATE TABLE `appartenenze` (
  ...
  UNIQUE KEY `cartaFedelta` (`cartaFedelta`),
  KEY `utente` (`utente`),
  CONSTRAINT `appartenenze_ibfk_1` FOREIGN KEY (`utente`) REFERENCES `utenti` (`codUtente`),
  CONSTRAINT `appartenenze_ibfk_2` FOREIGN KEY (`cartaFedelta`) REFERENCES `carte_fedelta` (`codCarta`)
